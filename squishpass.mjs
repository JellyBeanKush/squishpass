...
const LEVEL_DATA = {
    ...
    3: { points: 10, reward: "Music Madness", description: "The ultimate Songbattle.io showdown. Viewers add tracks all month long, ending in a massive review stream to vote on new HBS playlist hits." },
    4: { points: 15, reward: "x2 HoneyBuns", description: "The hype train is moving! Everyone earns double HoneyBuns for the remainder of the month." },
    5: { points: 22, reward: "+5 Hours", description: "Boosting the schedule again! Another 5 hours added to the monthly stream bank." },
    6: { points: 30, reward: "Art Pack", description: "Exclusive HBS goodies! Unlocks a monthly drop of custom mobile/desktop wallpapers and printable coloring pages." },
    ...
    9: { points: 80, reward: "Movie Night", description: "Grab the popcorn and settle in. We’re hosting a Discord hangout to watch 2-3 films together." },
    ...
    12: { points: 140, reward: "x3 HoneyBuns", description: "Triple time! The HoneyBun multiplier is officially upgraded to x3." },
    ...
    15: { points: 215, reward: "Karaoke", description: "Mic check, 1-2! A high-energy karaoke stream where we sing (or try to) our favorite tracks live." },
    ...
    18: { points: 290, reward: "x4 HoneyBuns", description: "Insane gains! Everyone is now earning x4 HoneyBuns until the end of the month." },
    ...
    22: { points: 405, reward: "Cooking Stream", description: "HoneyBear and JellyBean take over the kitchen to prepare a fancy, 3+ course meal live on camera." },
    ...
    26: { points: 525, reward: "Shirtless 'til Reset", description: "The ultimate stream challenge! Once unlocked, we stay shirtless on stream until the monthly reset." },
    27: { points: 560, reward: "x5 HoneyBuns", description: "MAX MULTIPLIER! Enjoy x5 HoneyBuns for all viewers until the end of the month." },
    28: { points: 595, reward: "+5 Hours", description: "The final 5-hour addition to the monthly stream time bank." },
    29: { points: 630, reward: "Special Outfit", description: "The community choice! HoneyBear debuts the Maid Outfit (or whichever look we decide on next)!" },
...
async function main() {
    ...
    const fileName = `SP - LVL${currentLevel} - FEB26.png`;
